<?php
//$this->set_css($this->default_theme_path . '/appsvision/css/demo_table_jui.css');
$this->set_css($this->default_css_path . '/ui/simple/' . grocery_CRUD::JQUERY_UI_CSS);
$this->set_css($this->default_theme_path . '/appsvision/css/appsvision.css');
$this->set_css($this->default_theme_path . '/appsvision/css/jquery.appsvision.css');
$this->set_css($this->default_theme_path . '/appsvision/extras/TableTools/media/css/TableTools.css');
...
$this->set_js_lib($this->default_theme_path . '/appsvision/js/jquery.dataTables.min.js');
$this->set_js($this->default_theme_path . '/appsvision/js/datatables-extras.js');
$this->set_js($this->default_theme_path . '/appsvision/js/appsvision.js');
$this->set_js($this->default_theme_path . '/appsvision/extras/TableTools/media/js/ZeroClipboard.js');
$this->set_js($this->default_theme_path . '/appsvision/extras/TableTools/media/js/TableTools.min.js');
...
<div id='list-report-success' class="display_none alert alert-success alert-dismissable" <?php if ($success_message !== null) { ?>style="display:block"<?php } ?>>
    <button aria-hidden="true" data-dismiss="alert" class="close" type="button"><i class="fa fa-fw fa-times"></i></button>
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="dataTablesContainer">
                        <?php if (!$unset_add) { ?>
                            <div class=""> <a role="button" class="add_button ui-button ui-widget ui-state-default ui-corner-all ui-button-text-icon-primary" href="<?php echo $add_url ?>"><span class="btn btn-primary"><i class="fa fa-edit"></i>&nbsp;<?php echo $this->l('list_add'); ?> <?php echo $subject ?></span> </a> </div>
                        <?php } ?>
