            ...
            <table id="data_table" class="table table-bordered table-striped to-right">
                ...
                <tbody>
                    <?php foreach ($participants as $participant): ?>
                        <tr>
                            <td>
                                <a href="<?= site_url('participant/delete/' . $participant->participant_id); ?>" data-confirm="Are you sure you want to delete?"><i class="fa fa-trash"></i></a>&ensp;
                                <a href="<?= site_url('participant/update/' . $participant->participant_id); ?>"><i class="fa fa-edit"></i></a>&ensp;
                                <a href="<?= site_url('participant/read/' . $participant->participant_id); ?> "><i class="fa fa-eye"></i></a>&ensp;
                                <?php if ($this->session->userdata('active_event')): ?>
                                <a href="<?= site_url('registration/manual_entry/' . $participant->participant_id); ?>" title="Add to current program as present"><i class="fa fa-calendar"></i></a>
                                <?php endif;?>
                            </td>
