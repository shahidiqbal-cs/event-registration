 ...
 */
$config['APIUsername'] = $config['Sandbox'] ? 'shahid_api1.apps-vision.co.uk' : 'PRODUCTION_USERNAME_GOES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? '7U7N7AVLHVT7BSK5' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'AiPC9BjkCyDFQXbSkoZcgqH3hpacAAUcYTFIPzC3TerCR2xU.P5wCYeb' : 'PRODUCTION_SIGNATURE_GOES_HERE';
 ...
 */
$config['DeveloperEmailAccount'] = 'appsvision.dev@gmail.com';
