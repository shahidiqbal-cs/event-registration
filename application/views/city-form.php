    ...
    <form action="" method="post">
        <div class="box-body to-right">
            <div class="form-group<?= (form_error('organization_name')) ? ' has-error' : ''; ?>">
                ...
                <input class="form-control" placeholder="<?= lang('name') . ' ' . lang('city'); ?>" name="organization_name" value="<?= $organization_name; ?>" />
            ...
            <div class="form-group<?= (form_error('organization_parent')) ? ' has-error' : ''; ?>">
                ...
                <select class="form-control" name="organization_parent">
                    <?php foreach ($zones as $zone): ?>
                        <option value="<?= $zone->zone_id; ?>" <?= ($zone->zone_id == $organization_parent) ? 'selected' : ''; ?>><?= $zone->zone_name; ?></option>
                    <?php endforeach; ?>
                </select>
