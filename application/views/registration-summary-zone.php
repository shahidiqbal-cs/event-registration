<?php if ($summary): ?>
    <div class="nav-tabs-custom" id="print_section">
        <ul class="nav nav-tabs hidden-print">
            ...
            <li class="active"><a href="#tab_overall_summary_city_no_status" data-toggle="tab">
                    <?= lang('summary') . ' ' . lang('city'); ?>
                </a></li>
            <li class="pull-right">
                <button class="btn btn-default" id="" onclick="window.print()"><i class="fa fa-print"></i> Print
                </button>
            </li>
        </ul>
        <div class="tab-content">
            ...
            <div class="tab-pane clearfix" id="tab_overall_summary_zone">
                ...
                <table class="table table-bordered table-striped group-table text-center">
                    ...
                    <?php endforeach; ?>
                    <tr>
                        <th><?= ($overall_total) ? round(((($overall_present + $overall_half_leave) / ($overall_total)) * 100), 2) : '0'; ?>
                            %
                        </th>
                        <th><?= $overall_total; ?></th>
                    ...
                    foreach ($summary as $key => $summary_by_type):
                        ...
                        foreach ($summary_by_type['zones'] as $zone_summary):
                            ...
                            foreach ($zone_summary['cities'] as $city_summary):
                                ?>
                                <tr>
                                    <td><?= ($city_summary['total']) ? round(((($city_summary['present'] + $city_summary['half_leave']) / ($city_summary['total'])) * 100), 2) : '0'; ?>
                                        %
                                    </td>
            ...
            <?php @include("registration-summary-tab.php") ?>
            <!--End OverAll summary-->
        </div><!-- /.tab-content -->
    </div><!-- nav-tabs-custom -->
<?php endif; ?>